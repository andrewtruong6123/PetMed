...
namespace Utilities
{
    ...
    {
        // np Connection String - used for testing application on server.
        //String SqlConnectString = "server=np-stem.temple.edu;Database=CIS4396_21_F06;User id=usrCIS4396_21_F06;Password=R0binEagle";

        // Main Connection String - used for the final and live application.
        //String SqlConnectString = "server=pre-stem.temple.edu;Database=CIS4396_21_F06;User id=usrCIS4396_21_F06;Password=R0binEagle";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1;Database=CIS4396_21_F06;User id=usrCIS4396_21_F06;Password=R0binEagle";

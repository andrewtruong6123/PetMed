<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="noPermission.aspx.cs" Inherits="AssetManagement.secure.noPermission" %>
...
<head runat="server">
    ...
    <!--Referencing Bootstrap JS/CSS CDNs with integrity and security-->
    ...
    <div id="navBar">
        <nav class="navbar-temple navbar-fixed-top">
            <div class="navbar-header">
                <a id="logoLink" runat="server" class="navbar-brand" href="Dashboard.aspx">Back to Dashboard</a>
            </div>
        </nav>
    </div>
    <div class="container">
        <div id="content" class="starter-template">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8">
                ...
                <p>You <b>WILL</b> close your browser to complete the logout process.</p>
            </div>
            <div class="col-md-2 col-lg-2"></div>
        </div>
    </div>

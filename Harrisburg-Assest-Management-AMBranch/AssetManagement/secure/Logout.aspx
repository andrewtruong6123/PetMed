<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="AssetManagement.Logout" %>
    ...
    <div id="navBar">
        <nav class="navbar-temple navbar-fixed-top">
            <div class="navbar-header">
                <a id="logoLink" runat="server" class="navbar-brand" href="../Login.aspx">Back to Login</a>
            </div>
        </nav>
    </div>
    <div class="container">
